...
foreach ($marker in @("VOICE_AGENT_LOCAL_LAB 1", "VOICE_AGENT_WS_URL", "VOICE_AGENT_WS_TOKEN", "VOICE_AGENT_WIFI_SSID", "VOICE_AGENT_WIFI_PASSWORD")) {
...
foreach ($key in @("XIAOZHI_LAB_TOKEN", "XIAOZHI_WIFI_PASSWORD")) {
    $value = $secrets[$key]
