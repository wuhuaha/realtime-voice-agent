...
int TestProfiles() {
    ...
    if (Expect(ParseTransportProfile("wss-opus-v2") == TransportProfile::kWssOpusV2, 15)) return 15;
    ...
    if (Expect(ToWireName(TransportProfile::kWssOpusV2) == "wss-opus-v2", 16)) return 16;
...
int TestSessionGate() {
    ...
    if (Expect(gate.CommitMedia(TransportProfile::kWssOpusV2, MediaOwner::kWss), 38)) return 38;
